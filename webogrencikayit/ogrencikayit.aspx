<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ogrencikayit.aspx.cs" Inherits="webogrencikayit.ogrencikayit" %>
    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="giris.aspx">Okulum</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="index.html" class="drop-text">Neler Yaptık?</a></li>
                                    <li><a href="index.html" class="drop-text">Popüler Kurslar</a></li>
                                    <li><a href="index.html" class="drop-text">İstatistik</a></li>
    ...
    <div class="inner-banner-w3ls py-5" id="home">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="modal-body mt-md-2 mt-5">
                <h3 class="title-w3 mb-5 text-center text-wh font-weight-bold">Şimdi Kaydol</h3>
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        <label class="col-form-label">Kullanıcı Adı: </label>
                 
                        <asp:TextBox ID="TextBox1" runat="server" placeholder="kullanıcıadı.." ></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Email: </label>
                       <%-- <input type="email" class="form-control" placeholder="@gmail.com.." name="Email"
                            required="">--%>
                        <asp:TextBox ID="TextBox2" runat="server" placeholder="@gmail.com.." Width="189px" ></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şehir: </label>
                  <%--      <input type="password" class="form-control" placeholder="şehir.." name="Password" required="">--%>
                         <asp:TextBox ID="TextBox3" runat="server" placeholder="şehir.." Width="189px" ></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şifre: </label>
                   <%--     <input type="password" class="form-control" placeholder="*****" name="Password" required="">--%>
                         <asp:TextBox ID="TextBox4" runat="server" placeholder="******" TextMode="Password" Width="195px" ></asp:TextBox>
                    </div>
                    <div class="sub-w3l my-3">
                        <div class="sub-w3layouts_hub">
                            <input type="checkbox" id="brand1" value="">
                            <label for="brand1" class="text-li text-style-w3ls">
                                <span></span>Şartları Okudum kabul ediyorum</label>
                        </div>
                    </div>
                    <%--<button type="submit" class="btn button-style-w3">Register</button>--%>
                    <asp:Button ID="Button1" runat="server" Text="Kaydol" class="btn btn-warning" OnClick="Button1_Click" />
                </form>
            </div>
            <!-- //register -->
        </div>
